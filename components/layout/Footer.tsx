        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-2 text-sm">
              ...
              <a
                href="mailto:info@paragliding-oludeniz.com"
                className="flex items-center gap-2 text-slate-400 hover:text-orange-400 transition-colors"
              >
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-slate-500">
            ...
            <Link href="/certifications" className="hover:text-slate-300 transition-colors">
              Certifications
            </Link>
            <Link href="/safety-record" className="hover:text-slate-300 transition-colors">
              Safety
            </Link>

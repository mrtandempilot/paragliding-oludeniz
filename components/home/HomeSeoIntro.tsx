...
const CONTENT: Record<string, SeoContent> = {
  en: {
    ...
    p4: 'Tandem flights are $140 per person, with transfer, all equipment and beach landing included. No hidden extras: a photo and video package is an optional $35 add-on, and if the weather turns, we reschedule free or you don’t pay.',
  ...
  tr: {
    ...
    p4: 'Tandem uçuşlar kişi başı $140’dır; transfer, tüm ekipman ve plaja iniş dahildir. Gizli ücret yok: foto-video paketi $35 karşılığında opsiyonel bir ek hizmettir, hava bozarsa ücretsiz erteleriz ya da ödeme almayız.',
  ...
  de: {
    ...
    p4: 'Tandemflüge kosten $140 pro Person — inklusive Transfer, kompletter Ausrüstung und Strandlandung. Keine versteckten Kosten: Ein Foto- und Videopaket ist als Zusatzoption für $35 erhältlich, und bei Wetterumschwung verschieben wir kostenlos oder Sie zahlen nichts.',
  ...
  ru: {
    ...
    p4: 'Тандемные полёты стоят $140 с человека, включая трансфер, всё снаряжение и посадку на пляж. Без скрытых доплат: фото- и видеопакет доступен отдельно за $35, а при плохой погоде мы бесплатно переносим полёт или вы не платите.',

...
const CONTENT: Record<string, SeoContent> = {
  en: {
    ...
    p4: 'Tandem flights start from $160 with transfer, all equipment and beach landing included. No hidden extras: a professional photo & video package is available for $35, and if the weather turns, we reschedule free or you don’t pay.',
  ...
  tr: {
    ...
    p4: 'Tandem uçuşlar $160’dan başlar; transfer, tüm ekipman ve plaja iniş dahildir. Gizli ücret yok: profesyonel foto & video paketi $35 karşılığında mevcuttur, hava bozarsa ücretsiz erteleriz ya da ödeme almayız.',
  ...
  de: {
    ...
    p4: 'Tandemflüge ab $160 — inklusive Transfer, kompletter Ausrüstung und Strandlandung. Keine versteckten Kosten: Ein professionelles Foto- & Videopaket ist für $35 erhältlich, und bei Wetterumschwung verschieben wir kostenlos oder Sie zahlen nichts.',
  ...
  ru: {
    ...
    p4: 'Тандемные полёты — от $160, включая трансфер, всё снаряжение и посадку на пляж. Без скрытых доплат: профессиональный фото- и видеопакет доступен за $35, а при плохой погоде мы бесплатно переносим полёт или вы не платите.',

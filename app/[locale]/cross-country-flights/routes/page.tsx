...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"XC Paragliding Routes from Babada\\u011f Oludeniz\", \"description\": \"Cross-country paragliding routes from Babada\\u011f Mountain \\u2014 distances, waypoints and tips.\", \"url\": \"https://paragliding-oludeniz.com/cross-country-flights/routes\", \"author\": {\"@type\": \"Person\", \"name\": \"Ceyhun\", \"url\": \"https://paragliding-oludeniz.com/en/about-us\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"Paragliding Oludeniz\", \"url\": \"https://paragliding-oludeniz.com\"}}" }} />

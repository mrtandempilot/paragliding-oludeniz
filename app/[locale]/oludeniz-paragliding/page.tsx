...
const CONTENT: Record<string, C> = {
  en: {
    ...
    faq: [
      ...
      { question: 'How much does paragliding in Ölüdeniz cost?', answer: 'Tandem flights are a fixed $150, all-inclusive — transfer to the launch, all equipment, insurance, beach landing, and a professional photo & video package. No add-ons, no discounts.' },
  ...
  tr: {
    ...
    practical: 'Ölüdeniz, Fethiye’ye 15 km, Dalaman Havalimanı’na (DLM) yaklaşık bir saat mesafededir. Tandem uçuşlar transfer, tüm ekipman, sigorta, plaja iniş ve profesyonel foto & video paketi dahil sabit $150’dir — güncel paketler için fiyatlar sayfamıza bakın. Yerel operatörden doğrudan rezervasyon, WhatsApp’ta doğrudan pilotlarla konuşmak ve hava nedeniyle ertelemenin ücretsiz olması demektir.',
    faq: [
      ...
      { question: 'Ölüdeniz’de yamaç paraşütü ne kadar?', answer: 'Tandem uçuşlar kalkışa transfer, tüm ekipman, sigorta, plaja iniş ve profesyonel foto & video paketi dahil sabit $150’dir. Ek ücret yok, indirim yok.' },
  ...
  de: {
    ...
    practical: 'Ölüdeniz liegt 15 km von Fethiye und rund eine Stunde vom Flughafen Dalaman (DLM). Tandemflüge sind ein Festpreis von $150, alles inklusive — Transfer, komplette Ausrüstung, Versicherung, Strandlandung und ein professionelles Foto- & Videopaket — aktuelle Pakete auf unserer Preisseite. Direkt beim lokalen Veranstalter buchen heisst: WhatsApp-Kontakt zu den Piloten selbst und kostenloses Verschieben bei Wetter.',
    faq: [
      ...
      { question: 'Was kostet Paragliding in Ölüdeniz?', answer: 'Tandemflüge sind ein Festpreis von $150, alles inklusive — Transfer zum Startplatz, komplette Ausrüstung, Versicherung, Strandlandung und ein professionelles Foto- & Videopaket. Keine Zusatzkosten, keine Rabatte.' },
  ...
  ru: {
    ...
    practical: 'Олюдениз — в 15 км от Фетхие и примерно в часе езды от аэропорта Даламан (DLM). Тандемные полёты — это фиксированная цена $150, всё включено: трансфер, всё снаряжение, страховка, посадка на пляж и профессиональный фото- и видеопакет; актуальные пакеты — на странице цен. Прямое бронирование у местного оператора — это WhatsApp с самими пилотами и бесплатный перенос по погоде.',
    faq: [
      ...
      { question: 'Сколько стоит полёт в Олюденизе?', answer: 'Тандемные полёты — это фиксированная цена $150, всё включено: трансфер к старту, всё снаряжение, страховка, посадка на пляж и профессиональный фото- и видеопакет. Без доплат и скидок.' },

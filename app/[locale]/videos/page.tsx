...
const CONTENT: Record<string, C> = {
  en: {
    ...
    intro: 'Every video below was filmed by our own pilots during real tandem flights from Babadağ. No stock footage, no drone tricks — this is exactly what your flight will look like. A professional photo & video package is included on every Atmos flight at no extra cost, so after you land you can take home a film like these of your own.',
    videos: [
  ...
  tr: {
    ...
    intro: 'Aşağıdaki her video, Babadağ’dan yapılan gerçek tandem uçuşlarda kendi pilotlarımız tarafından çekildi. Stok görüntü yok, drone numarası yok — uçuşunuz tam olarak böyle görünecek. Her Atmos uçuşunda profesyonel foto & video paketi ek ücret ödemeden dahildir; indiğinizde siz de kendi uçuşunuzun böyle bir filmiyle dönebilirsiniz.',
    videos: [

...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { url: localeUrl(locale, '/acro-flights/events'), description: (d as any)[locale] || d.en, images: ['https://www.atmosparagliding.com/acro-flights/opengraph-image'] },

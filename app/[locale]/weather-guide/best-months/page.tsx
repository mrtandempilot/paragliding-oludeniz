...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: localeAlternates(locale, '/weather-guide/best-months'),
    openGraph: { url: localeUrl(locale, '/weather-guide/best-months'), description: (d as any)[locale] || d.en },
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"Best Months for Paragliding in Oludeniz\", \"description\": \"Guide to the best months for paragliding in Oludeniz \\u2014 weather, thermals and flight conditions.\", \"url\": \"https://paragliding-oludeniz.com/weather-guide/best-months\", \"author\": {\"@type\": \"Person\", \"name\": \"Ceyhun\", \"url\": \"https://paragliding-oludeniz.com/en/about-us\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"Paragliding Oludeniz\", \"url\": \"https://paragliding-oludeniz.com\"}}" }} />

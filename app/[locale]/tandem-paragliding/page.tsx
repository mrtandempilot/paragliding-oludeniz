...
const CONTENT: Record<string, PageContent> = {
  ...
  tr: {
    whyTitle: 'Neden Oludeniz Dunyanin En Unlu Yamac Parasutu Noktasi?',
    whyBody: '1.960 metrelik bir dagin turkuaz bir lagune neredeyse dik indigi dunyada cok az yer vardir; Oludeniz bunlardan biridir. Babadag\u2019in yuksekligi, guvenilir termikleri ve plajin hemen ustundeki genis kumlu inis alani \u2014 her kitadan pilotun buraya gelmesinin ve Oludeniz\u2019de tandem ucusun bu kadar populer olmasinin sebebi bu kombinasyondur. Ucuslar Nisan\u2019dan Kasim\u2019a kadar her gun yapilir; kalkis noktasi (1.200\u20131.900 m) gunun ruzgar ve hava durumuna gore secilir. Deneyim, ozel bir kondisyon veya ekipman gerekmez \u2014 her seyi pilotunuz halleder.',
    stepsTitle: 'Tandem Ucusunuz Adim Adim Nasil Gecer?',
    steps: [
      { t: '1. Bulusma ve transfer (yaklasik 40 dakika)', d: 'Oludeniz\u2019de bulusur, servisimizle Babadag\u2019a cikariz. Yolun kendisi bile bir deneyimdir \u2014 cam ormani, virajlar ve asagida kuculen lagun.' },
      { t: '2. Kalkista brifing (10\u201315 dakika)', d: 'Pilotunuz harness ve kaskinizi takar, kalkisi anlatir, tum sorularinizi yanitlar. En onemli talimat en basitidir: pilot kos dediginde, ayaklariniz yerden kesilene kadar kosmaya devam edin.' },
      { t: '3. Kalkis (birkac saniye)', d: 'Birlikte 5\u201310 adim kosarsiniz, kanat uzerinizde dolar ve dag ayaklarinizin altindan cekilir. Cogu misafir bu anin beklediginden cok daha yumusak oldugunu soyler \u2014 atlama ve serbest dusus yoktur.' },
      { t: '4. Ucus (25\u201345 dakika)', d: 'Rahat bir koltukta oturursunuz; pilotunuz Kumburnu, Belcekiz Plaji ve Kelebekler Vadisi uzerinde termiklerle suzulur. Sakin bir ucus mu istersiniz? Soylemeniz yeterli. Spiral ve G kuvveti mi? Akrobasi isteyin \u2014 ucus sizin.' },
      { t: '5. Plaja inis', d: 'Belcekiz Plaji\u2019ndaki yuruyus yoluna yumusakca inersiniz \u2014 genellikle alkislayan bir seyirci kitlesi esliginde.' },
    ],
    stepsOutro: 'Toplam sure: kapidan kapiya yaklasik 2 saat.',
    optTitle: 'Ucusunuzu Secin',
    options: [
      { name: 'Standart Ucus (1.700 m)', price: '\u20AC100', desc: 'Lagun uzerinde 25\u201335 dakika \u2014 klasik Oludeniz deneyimi.' },
      { name: 'Yuksek Irtifa Ucusu (1.900 m)', price: '\u20AC100', desc: 'Zirveye yakin kalkisla en uzun manzara; hava durumuna baglidir.' },
      { name: 'Gun Batimi Ucusu', price: '\u20AC110', desc: 'Ege uzerinde altin saat isigi \u2014 fotografcilarin favorisi.' },
    ],
    optNote: 'Foto ve video paketleri opsiyonel ektir \u2014 pilotunuz tum ucusu gimbal kamerayla ceker.',
    safetyTitle: 'Guvenlik Bir Ozellik Degil, Sistemin Kendisidir',
    safetyBody: 'Her Atmos pilotu SHGM lisanslidir ve binlerce tandem ucusa sahiptir. Kanatlar, harnessler ve yedek parasutler her gun kontrol edilir; eskidiginde degil, uretici takvimine gore degistirilir. Her ucusta ucuncu sahis sorumluluk sigortasi vardir ve kosullar uygun degilse ucmayiz \u2014 ruzgar hayir diyorsa ucusunuzu ucretsiz erteleriz. Oludeniz otuz yilda milyonlarca tandem ucusa ev sahipligi yapti; lisansli bir profesyonelle yapildiginda en guvenli macera sporlarindan biridir.',
    timeTitle: 'Ucmak Icin En Iyi Zaman',
    timeBody: 'Sezon Nisan sonundan Kasim basina surer. Haziran\u2013Eylul en istikrarli kosullari ve en uzun ucus gunlerini sunar; Mayis ve Ekim daha berrak hava, yumusak isik ve az kalabalik demektir. Sabah ucuslari genellikle en sakinidir \u2014 heyecanliysaniz idealdir. Ogleden sonra termikleri daha uzun ve hareketli ucuslar verir. Temmuz ve Agustos gunler oncesinden dolar; yuksek sezonda erken rezervasyon yapin.',
    knowTitle: 'Ucustan Once Bilmeniz Gerekenler',
    knowBody: 'Rahat kiyafet ve kapali ayakkabi giyin \u2014 spor ayakkabi idealdir. Agustos\u2019ta bile ince bir mont alin; 1.900 m\u2019de hava belirgin sekilde serindir. Gunes gozlugu onerilir. Maksimum yolcu kilosu 110 kg\u2019dir; 18 yas alti icin veli onayi gerekir. Gozluk ve telefon ucabilir ama sabitleyin \u2014 lagun yakaladigini geri vermez.',
    atmosTitle: 'Aracisiz, Yerel Pilot Ekibiyle Ucun',
    atmosBody: 'Aracilar uzerinden rezervasyonda buyuk bir komisyon, eline hic kanat almamis bir aracinin cebine gider. Atmos, 25 yili askin suredir Babadag\u2019dan ucan, pilotlarin sahibi oldugu yerel bir ekiptir. Dogrudan rezervasyon daha iyi fiyat, pilotunuzla dogrudan WhatsApp iletisimi ve hava degistiginde ucretsiz erteleme demektir.',
    faq: [
      { question: 'Tandem ucus icin deneyim gerekir mi?', answer: 'Hayir, hicbir deneyim gerekmez. Tandem ucusta her seyi kontrol eden sertifikali bir pilota baglisiniz. Tek isiniz kalkista birkac adim kosmak ve ucusun tadini cikarmak.' },
      { question: 'Kilo veya yas siniri var mi?', answer: 'Maksimum yolcu agirligi 110 kg\u2019dir. 18 yas alti yolcular icin veli onayi gerekir.' },
      { question: 'Ne giymeliyim?', answer: 'Rahat, katmanli kiyafet ve kapali ayakkabi. Yaninize ince bir mont alin \u2014 yukseklerde hava serin olabilir.' },
      { question: 'Ucus ne kadar surer?', answer: 'Pakete ve hava kosullarina gore 25\u201345 dakika arasi.' },
      { question: 'Oludeniz\u2019de yamac parasutu guvenli mi?', answer: 'SHGM lisansli profesyonel pilotla yapilan tandem ucus en guvenli macera aktivitelerinden biridir. Ekipman her gun kontrol edilir, her ucus sigortalidir ve yalnizca guvenli kosullarda ucus yapilir.' },
      { question: 'Hava kotu olursa ne olur?', answer: 'Once guvenlik: kosullar uygun degilse ucusunuz ucretsiz olarak bir sonraki musait saate ertelenir. Yeni tarih bulamazsaniz ucret alinmaz.' },
      { question: 'Telefonumu veya kameramı getirebilir miyim?', answer: 'Evet, ancak askili veya fermuarli cepte sabitlenmelidir. Cogu misafir foto-video paketimizi tercih eder \u2014 pilot gimbal kamerayla cekerken siz manzaranin tadini cikarirsiniz.' },
      { question: 'Nasil rezervasyon yapilir, kapora gerekir mi?', answer: 'Iki dakikada online rezervasyon yapabilir veya WhatsApp\u2019tan yazabilirsiniz. Cogu donemde on odemesiz yer ayirtabilirsiniz; Temmuz\u2013Agustos icin talep nedeniyle kucuk bir kapora istenebilir.' },
      { question: 'Tam olarak nerede bulusuyoruz?', answer: 'Oludeniz merkezde, Belcekiz Plaji yakininda bulusuyoruz \u2014 kesin nokta ve saat ucustan onceki aksam WhatsApp\u2019tan teyit edilir. Oludeniz cevresinde otelden alma ayarlanabilir.' },
    ],
  },
  de: {

...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const bodies: Record<string,string[]> = {en:["Sunset flights launch from the 1200m takeoff point in the late afternoon (typically 17:00-18:30, depending on season). The air is calmer, the thermals are gentler, and the light is extraordinary.","As you soar above the Blue Lagoon, the sky transforms from blue to gold to deep orange. The silhouette of Babadag behind you, the islands in the distance, the turquoise water below — photographers agree this is one of the most beautiful paragliding experiences in the world.","Sunset flights last approximately 20-30 minutes. We include a professional photo package with all sunset flights. Slots are very limited — book at least 2-3 days in advance in peak season.","Price: $140 per person. Includes all equipment, transfer to launch, and pilot. A professional photo & video package is available as a $35 add-on."],tr:["Gün batımı uçuşları öğleden sonra geç saatlerde 1200m kalkış noktasından yapılır (genellikle sezona bağlı olarak 17:00-18:30). Hava daha sakin, termikler daha yumuşak ve ışık olağanüstü.","Mavi Lagün üzerinde süzülürken gökyüzü maviden altına ve derin turuncuya dönüşür. Arkanda Babadağ'ın silüeti, uzakta adalar, aşağıda turkuaz sular — fotoğrafçılar bunun dünyanın en güzel paraşüt deneyimlerinden biri olduğu konusunda hemfikir.","Gün batımı uçuşları yaklaşık 20-30 dakika sürer. Tüm gün batımı uçuşlarına profesyonel fotoğraf paketi dahildir. Yoğun sezonda en az 2-3 gün önceden rezervasyon yapın.","Fiyat: kişi başı $140. Tüm ekipman, kalkışa transfer ve pilot dahildir. Profesyonel foto & video paketi $35 karşılığında opsiyonel ek hizmettir."],de:["Sonnenuntergangsflüge starten am späten Nachmittag vom 1200m Startplatz (typischerweise 17:00-18:30, je nach Saison). Die Luft ist ruhiger, die Thermik sanfter und das Licht außergewöhnlich.","Während Sie über die Blaue Lagune gleiten, verwandelt sich der Himmel von Blau in Gold und tiefes Orange. Die Silhouette des Babadağ hinter Ihnen, die Inseln in der Ferne, das türkisfarbene Wasser unten — Fotografen sind sich einig, dass dies eines der schönsten Paragliding-Erlebnisse der Welt ist.","Sonnenuntergangsflüge dauern ca. 20-30 Minuten. Alle Sonnenuntergangsflüge beinhalten ein professionelles Fotopaket. Plätze sind sehr begrenzt — buchen Sie in der Hochsaison mindestens 2-3 Tage im Voraus.","Preis: $140 pro Person. Inklusive Ausrüstung, Transfer zum Start und Pilot. Ein professionelles Foto- & Videopaket ist als Zusatzoption für $35 erhältlich."],ru:["Закатные полёты стартуют с площадки 1200м в конце дня (обычно 17:00-18:30, в зависимости от сезона). Воздух спокойнее, термики мягче, а освещение исключительное.","Паря над Голубой Лагуной, небо меняется от синего к золотому и тёмно-оранжевому. Силуэт Бабадага позади, острова вдали, бирюзовая вода внизу — фотографы согласны, что это один из самых красивых парапланерных опытов в мире.","Закатные полёты длятся около 20-30 минут. Все закатные полёты включают профессиональный фотопакет. Места очень ограничены — бронируйте за 2-3 дня в пик сезона.","Цена: $140 за человека. Включает всё снаряжение, трансфер к месту старта и пилота. Профессиональный фото- и видеопакет доступен отдельно за $35."]}

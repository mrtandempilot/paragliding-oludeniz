...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { url: localeUrl(locale, '/tandem-paragliding/group-flights'), description: (d as any)[locale] || d.en, images: ['https://www.atmosparagliding.com/tandem-paragliding/opengraph-image'] },

...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { url: localeUrl(locale, '/pilot-services/radio-hire'), description: (d as any)[locale] || d.en, images: ['https://www.atmosparagliding.com/pilot-services/opengraph-image'] },

...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { url: localeUrl(locale, '/babadag-guide/babadag-altitude-sickness'), description: (d as any)[locale] || d.en },
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"Altitude Sickness on Babada\\u011f\", \"description\": \"Understanding altitude sickness risks on Babada\\u011f Mountain and how to stay safe while paragliding.\", \"url\": \"https://paragliding-oludeniz.com/babadag-guide/babadag-altitude-sickness\", \"author\": {\"@type\": \"Person\", \"name\": \"Ceyhun\", \"url\": \"https://paragliding-oludeniz.com/en/about-us\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"Paragliding Oludeniz\", \"url\": \"https://paragliding-oludeniz.com\"}}" }} />

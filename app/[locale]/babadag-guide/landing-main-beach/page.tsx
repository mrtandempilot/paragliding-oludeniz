...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const t = {en:"Main Beach Landing Zone",tr:"Ana Plaj İniş Alanı",de:"Hauptstrand-Landezone",ru:"Основная зона приземления"}
  ...
  return {
    ...
    alternates: localeAlternates(locale, '/babadag-guide/landing-main-beach'),
    openGraph: { url: localeUrl(locale, '/babadag-guide/landing-main-beach'), description: (d as any)[locale] || d.en },
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const titles = {en:"Main Beach Landing Zone",tr:"Ana Plaj İniş Alanı",de:"Hauptstrand-Landezone",ru:"Основная зона приземления"}
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"Main Beach Landing Paragliding Oludeniz\", \"description\": \"Guide to landing on the main Oludeniz beach after your paragliding flight.\", \"url\": \"https://paragliding-oludeniz.com/babadag-guide/landing-main-beach\", \"author\": {\"@type\": \"Person\", \"name\": \"Ceyhun\", \"url\": \"https://paragliding-oludeniz.com/en/about-us\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"Paragliding Oludeniz\", \"url\": \"https://paragliding-oludeniz.com\"}}" }} />

...
export const alt = 'Atmos Paragliding Prices 2026 — Transparent Pricing from $140'
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, minWidth: 280 }}>
            {[
              { label: 'Standard (1200m)', price: '$140', note: '25–35 min' },
              { label: 'High Altitude (1700m)', price: '$140', note: '35–50 min', highlight: true },
              { label: 'Sunset Flight', price: '$140', note: '20–30 min' },
            ].map((pkg) => (
              <div
                key={pkg.label}
                style={{
